...
from .tools.gamedev_tools import (
    ...
    game_reverse_impact,
    game_search_knowledge,
    game_list_systems,
    game_propose_change,
    game_apply_proposal,
    game_commit_proposal,
)
    ...
    **must** call ``super()._acting(...)`` / ``super()._reasoning(...)``
    ...
    def _create_toolkit(
        ...
        tool_functions = {
            ...
            "game_query_tables": game_query_tables,
            "game_describe_field": game_describe_field,
            "game_table_dependencies": game_table_dependencies,
            "game_reverse_impact": game_reverse_impact,
            "game_search_knowledge": game_search_knowledge,
            "game_list_systems": game_list_systems,
            "game_propose_change": game_propose_change,
            "game_apply_proposal": game_apply_proposal,
            "game_commit_proposal": game_commit_proposal,
        }
