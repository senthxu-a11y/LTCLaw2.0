...
from ltclaw_gy_x.app.channels.matrix.channel import MatrixChannel
from ltclaw_gy_x.config.config import MatrixConfig
...
class TestMatrixChannelStartStop:
    ...
    async def test_start_creates_client(
        ...
        with patch(
            "ltclaw_gy_x.app.channels.matrix.channel.AsyncClient",
