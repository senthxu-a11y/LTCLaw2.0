...
import ltclaw_gy_x.providers.provider_manager as provider_manager_module
from ltclaw_gy_x.exceptions import ProviderError
from ltclaw_gy_x.providers.anthropic_provider import AnthropicProvider
...
from ltclaw_gy_x.providers.provider_manager import ProviderManager
from ltclaw_gy_x.local_models.llamacpp import LlamaCppServerSetupResult
...
def isolated_secret_dir(monkeypatch, tmp_path):
    secret_dir = tmp_path / ".ltclaw_gy_x.secret"
...
async def test_resume_local_model_restores_server_and_runtime_state(
    ...
    provider = manager.get_provider("ltclaw_gy_x-local")
