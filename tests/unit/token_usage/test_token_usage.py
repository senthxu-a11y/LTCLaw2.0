...
from ltclaw_gy_x.token_usage.buffer import (
    TokenUsageBuffer,
    _UsageEvent,
    _apply_event,
)
from ltclaw_gy_x.token_usage.manager import (
    TokenUsageByModel,
    TokenUsageManager,
    TokenUsageRecord,
    TokenUsageStats,
...
from ltclaw_gy_x.token_usage.model_wrapper import TokenRecordingModelWrapper
from ltclaw_gy_x.token_usage.storage import load_data, save_data_sync
...
class TestTokenUsageManagerCore:
    ...
    def test_get_instance_returns_singleton(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "ltclaw_gy_x.token_usage.manager.WORKING_DIR",
            tmp_path,
        )
        monkeypatch.setattr(
            "ltclaw_gy_x.token_usage.manager.TOKEN_USAGE_FILE",
