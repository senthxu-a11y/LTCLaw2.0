...
from ltclaw_gy_x.utils.logging import (
    ColorFormatter,
...
class TestAddFileHandler:
    ...
    def test_creates_log_directory(self, tmp_path):
        ...
        log_path = tmp_path / "logs" / "ltclaw_gy_x.log"
    ...
    def test_idempotent_same_path(self, tmp_path):
        ...
        log_path = tmp_path / "ltclaw_gy_x.log"
...
class TestLogConstants:
    ...
    def test_log_namespace_is_qwenpaw(self):
        """S级: LOG_NAMESPACE is 'ltclaw_gy_x'."""
        assert LOG_NAMESPACE == "ltclaw_gy_x"
    ...
    def test_log_namespace_used_by_setup(self):
        ...
        logger = logging.getLogger(LOG_NAMESPACE)
        assert logger.name == "ltclaw_gy_x"
