...
2. docs/tasks/knowledge/mvp/knowledge-p3-1-rag-read-boundary-review-2026-05-07.md
3. docs/tasks/knowledge/mvp/knowledge-p2-gate-status-2026-05-07.md
4. docs/tasks/knowledge/mvp/knowledge-p1-gate-status-2026-05-07.md
5. docs/tasks/knowledge/mvp/knowledge-admin-vs-fast-test-boundary-review-2026-05-07.md
6. docs/tasks/knowledge/mvp/knowledge-permission-boundary-review-2026-05-08.md
...
1. the Mac operator-side validation closeout is recorded in `docs/tasks/knowledge/pilot-validation/knowledge-post-mvp-operator-side-pilot-validation-2026-05-10.md`
2. the Windows operator-side validation closeout is recorded in `docs/tasks/knowledge/pilot-validation/knowledge-post-mvp-windows-operator-side-pilot-validation-2026-05-10.md`
...
1. A formal map read/save boundary review now exists in `docs/tasks/knowledge/mvp/knowledge-p3-7a-formal-map-read-save-boundary-review-2026-05-07.md`.
...
29. Post-MVP Final Handoff / Delivery Packaging is now complete in `docs/tasks/knowledge/pilot-validation/knowledge-post-mvp-final-handoff-delivery-packaging-2026-05-10.md`.
...
32. Post-MVP operator-side pilot validation is now complete in `docs/tasks/knowledge/pilot-validation/knowledge-post-mvp-operator-side-pilot-validation-2026-05-10.md`.
...
36. Post-MVP Windows operator-side pilot validation final hygiene receipt is now recorded in `docs/tasks/knowledge/pilot-validation/knowledge-post-mvp-windows-operator-side-pilot-validation-2026-05-10.md`.
...
56. Frontend permission copy review is recorded in `docs/tasks/knowledge/mvp/knowledge-frontend-permission-copy-review-2026-05-08.md`.
...
68. Broader read capability checks boundary review is recorded in `docs/tasks/knowledge/mvp/knowledge-read-permission-boundary-review-2026-05-08.md`.
...
87. Formal map review UX boundary review is recorded in `docs/tasks/knowledge/mvp/knowledge-p3-7c-formal-map-review-ux-boundary-2026-05-08.md`.
...
102. Formal map status edit boundary review is recorded in `docs/tasks/knowledge/mvp/knowledge-p3-7c-2-formal-map-status-edit-boundary-2026-05-08.md`.
...
124. `P3.7c-3-alpha` relationship edit boundary decision is recorded in `docs/tasks/knowledge/mvp/knowledge-p3-7c-3-relationship-edit-boundary-2026-05-08.md`.
...
128. Conservative P3.7 closeout is recorded in `docs/tasks/knowledge/mvp/knowledge-p3-7-conservative-closeout-2026-05-08.md`.
...
1. The closeout is recorded in `docs/tasks/knowledge/mvp/knowledge-p3-12-review-gate-closeout-2026-05-10.md`.
...
6. P0-P3 final handover is recorded in `docs/tasks/knowledge/mvp/knowledge-p0-p3-mvp-final-handover-2026-05-10.md`.
...
187. The planning file for `P3.rag-ui-2` is `docs/tasks/knowledge/mvp/knowledge-p3-rag-ui-2-product-flow-plan-2026-05-08.md`.
...
229. The planning file for `P3.rag-ui-3` is `docs/tasks/knowledge/mvp/knowledge-p3-rag-ui-3-product-experience-consolidation-plan-2026-05-08.md`.
...
264. The planning file for `P3.8` is `docs/tasks/knowledge/mvp/knowledge-p3-8-rag-routing-boundary-review-2026-05-09.md`.
...
276. The review file for `P3.8b` is `docs/tasks/knowledge/mvp/knowledge-p3-8b-workbench-affordance-boundary-review-2026-05-09.md`.
...
288. The closeout file for `P3.8c` is `docs/tasks/knowledge/mvp/knowledge-p3-8c-go-to-workbench-closeout-2026-05-09.md`.
...
305. The review file for `P3.8d` is `docs/tasks/knowledge/mvp/knowledge-p3-8d-structured-query-destination-discovery-2026-05-09.md`.
...
317. The contract file for `P3.8e` is `docs/tasks/knowledge/mvp/knowledge-p3-8e-structured-query-panel-contract-2026-05-09.md`.
...
329. The review file for `P3.8f` is `docs/tasks/knowledge/mvp/knowledge-p3-8f-structured-query-submit-contract-2026-05-09.md`.
...
344. The closeout file for `P3.8g` is `docs/tasks/knowledge/mvp/knowledge-p3-8g-minimal-structured-query-panel-closeout-2026-05-09.md`.
...
357. The closeout file for `P3.8h` is `docs/tasks/knowledge/mvp/knowledge-p3-8h-rag-mvp-interaction-validation-2026-05-09.md`.
