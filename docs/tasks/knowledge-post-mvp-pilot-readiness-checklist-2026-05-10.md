...
for f in docs/tasks/knowledge-post-mvp-pilot-readiness-checklist-2026-05-10.md \
  docs/tasks/knowledge-p0-p3-implementation-checklist.md \
  docs/tasks/knowledge-p3-gate-status-2026-05-07.md \
  docs/tasks/knowledge-p3-gate-consolidation-2026-05-08.md; do \
